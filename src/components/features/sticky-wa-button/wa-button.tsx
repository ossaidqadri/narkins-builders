...
export default function WAButton() {
  ...
  return (
    <Link
      href="#"
      className="fixed bottom-4 right-4 z-[999] flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-3 py-2 rounded-full shadow-lg transition-all duration-300 hover:scale-105"
